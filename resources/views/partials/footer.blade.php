<footer class='footer'>
    <div class='container'>
        <div class='footer-info'>
            <span>© 2025 Abbyero Aviation | 11357 Lindenwood Ave El Paso Texas.</span>
            <span id='footer_links'>
                <a href='/privacy'>Privacy Policy</a> • 
                <a href='/terms'>Terms & Conditions</a> • 
                <a href='/login' class='footer-login'>Login</a>
            </span>
        </div>
        ...
        <div id='footer_contact'>
            <span>
                ...
                <a href='tel:+1 (915) 9995352' class='px-2'>+1 (915) 9995352</a> 
                9am-6pm EST Mon - Fri
            </span>
        </div>
        ...
        <div class="mt-3" id='footer_social'>
            ...
            <a href='https://www.youtube.com/@AbbyeroAviationLLC' target='_blank' rel='noopener noreferrer'>
                <img alt='YouTube' 
                     ...
                     height='45' width='45' 
                     onerror="this.onerror=null;this.src='{{ asset('assets/images/index/yt-icon.png') }}'">
            </a>
        </div>
    </div>
</footer>
