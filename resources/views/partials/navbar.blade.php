<nav class="navbar navbar-expand-xxl sticky-top navbar-solid">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset('assets/images/logos/abbyerologo.png') }}" alt="Abbyero Aviation Logo" height="55"
                width="60" id="menu-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <a href="{{ route('cart.index') }}" class="btn position-relative mb-2">
                ...
                @auth
                    <form action="{{ route('logout') }}" method="POST" class="mb-5">
                        @csrf
                        <button type="submit" class="btn btn-danger mb-2" id="nav-btn-logout">Logout</button>
                    </form>
                @else
