            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOrders" class="accordion-collapse collapse" aria-labelledby="headingOrders"
                            data-bs-parent="#accountAccordion">
                            <div class="accordion-body">
                                <p>Here are your past orders with their items.</p>
                                        ...
                                        @foreach($orders as $order)
                                            <li class="list-group-item">
                                                <div class="mb-2">
                                                    ...
                                                    <small>
                                                        Placed on {{ $order->created_at->format('d M Y H:i') }} <br>
                                                        Status: <span class="badge bg-info">{{ ucfirst($order->status) }}</span><br>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-2">
                                                    <a href="{{ route('orders.invoice', $order->id) }}"
                                                        class="btn btn-sm light-blue-bg" target="_blank">
